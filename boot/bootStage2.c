/* Second Stage Bootloader for the RP2040
 * Responsible for initializing flash XIP (Execute In Place) mode
 * Sets up SSI interface and configures flash for quad output mode */
 ...
 * This function is placed in .boot2 section by the linker */
